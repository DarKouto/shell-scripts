...
**Alternative Method**: Download the <a id="raw-url" href="https://raw.githubusercontent.com/darkouto/shell-scripts/main/instalar-scripts">instalar-scripts</a> file file, make it executable and run it.
