...
**Alternative Method**: Download the <a download="instalar-scripts" href="https://raw.githubusercontent.com/DarKouto/shell-scripts/main/instalar-scripts">instalar-scripts</a> file file, make it executable and run it.
