...
**Alternative Method**: Download the [**instalar-scripts**](https://raw.githubusercontent.com/darkouto/shell-scripts/main/instalar-scripts) file, make it executable and run it.
