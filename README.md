...
**Alternative Method**: Download the <a href="https://raw.githubusercontent.com/darkouto/shell-scripts/main/instalar-scripts" download>instalar-scripts</a> file file, make it executable and run it.
